  ...
  <div class="cards">
    <div class="card">
      ...
      <div class="img-wrapper">
        <img src="./assets/images/projects/blog.gif" alt="GIF do projeto blog PHP." />
        <div class="buttons">
          <a href="https://github.com/LuizFelipeOliveiraMello/blog_php/blob/main/projeto_video2.mp4" target="_blank" title="Repositório no Github">
            ...
            <p>Blog full-stack focando mais no back-end, usando uma API para buscar os dados no banco de dados feito em PHP com SQLite. E um WebSocket para recarregar a página.</p>
    ...
    <div class="card">
      ...
      <p>Projeto simples mas legal com NextJS fazendo um TodoList.</p>
    ...
    <div class="card">
      ...
      <p>Uma ideia de site para fazer planos de carreira.</p>
      <p>HTML - CSS - JS - ReactJS</p>
    </div>
    <div class="card">
      <h3>Página de Login Conectado ao MySQL</h3>
      <div class="img-wrapper">
        <img src="./assets/images/projects/login.gif" alt="Imagem do projeto." />
        <div class="buttons">
          <a href="https://github.com/LuizFelipeOliveiraMello/login_APP" target="_blank" title="Repositório no Github">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
              <path fill="none" d="M0 0h24v24H0z" />
              <path d="M12 2C6.475 2 2 6.475 2 12a9.994 9.994 0 0 0 6.838 9.488c.5.087.687-.213.687-.476 0-.237-.013-1.024-.013-1.862-2.512.463-3.162-.612-3.362-1.175-.113-.288-.6-1.175-1.025-1.413-.35-.187-.85-.65-.013-.662.788-.013 1.35.725 1.538 1.025.9 1.512 2.338 1.087 2.912.825.088-.65.35-1.087.638-1.337-2.225-.25-4.55-1.113-4.55-4.938 0-1.088.387-1.987 1.025-2.688-.1-.25-.45-1.275.1-2.65 0 0 .837-.262 2.75 1.026a9.28 9.28 0 0 1 2.5-.338c.85 0 1.7.112 2.5.337 1.912-1.3 2.75-1.024 2.75-1.024.55 1.375.2 2.4.1 2.65.637.7 1.025 1.587 1.025 2.687 0 3.838-2.337 4.688-4.562 4.938.362.312.675.912.675 1.85 0 1.337-.013 2.412-.013 2.75 0 .262.188.574.688.474A10.016 10.016 0 0 0 22 12c0-5.525-4.475-10-10-10z" fill="rgba(255,255,255,1)" />
            </svg>
      ...
      <p>Simples página de login com banco de dados.</p>
      <p>HTML - CSS - JS - NodeJS - MySQL</p>
    </div>
    <div class="card">
      <h3>Doctor Care</h3>
      <div class="img-wrapper">
    ...
    <div class="card">
      ...
      <p>O presente site que desenvolvi para apresentar a mim e meus projetos.</p>
      <p>HTML - CSS - JS</p>
    </div>
    <div class="card">
      <h3>Em breve...</h3>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
        <path fill="none" d="M0 0h24v24H0z" />
        <path d="M5 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm14 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm-7 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" fill="rgba(255,255,255,1)" />
      </svg>
      <p>Aprendizado constante! <br /> Em breve muitos outros projetos.</p>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
        <path fill="none" d="M0 0H24V24H0z" />
        <path d="M21 3v2c0 9.627-5.373 14-12 14H5.243C5.08 19.912 5 20.907 5 22H3c0-1.363.116-2.6.346-3.732C3.116 16.974 3 15.218 3 13 3 7.477 7.477 3 13 3c2 0 4 1 8 0zm-8 2c-4.418 0-8 3.582-8 8 0 .362.003.711.01 1.046 1.254-1.978 3.091-3.541 5.494-4.914l.992 1.736C8.641 12.5 6.747 14.354 5.776 17H9c6.015 0 9.871-3.973 9.997-11.612-1.372.133-2.647.048-4.22-.188C13.627 5.027 13.401 5 13 5z" fill="rgba(255,255,255,1)" />
      </svg>
    </div>
  </div>
}
